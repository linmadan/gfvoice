const loadAndValidateSetPoetryVoiceStatusCommand = require('./setPoetryVoiceStatus');

const loadAndValidateRemoveImageCommand = require('./removeImage');

const loadAndValidateUpdateImageCommand = require('./updateImage');

const loadAndValidateCreateImageCommand = require('./createImage');

const loadAndValidateCheckAppUpdateCommand = require('./checkAppUpdate');

const loadAndValidateRemoveAppUpdateInfoCommand = require('./removeAppUpdateInfo');

const loadAndValidateUpdateAppUpdateInfoCommand = require('./updateAppUpdateInfo');

const loadAndValidateCreateAppUpdateInfoCommand = require('./createAppUpdateInfo');

const loadAndValidateSubmitFeedbackCommand = require('./submitFeedback');

const loadAndValidateRemoveWordCommand = require('./removeWord');

const loadAndValidateUpdateWordCommand = require('./updateWord');

const loadAndValidateCreateWordCommand = require('./createWord');
