...
const AppUpdateInfoService = require('./appUpdateInfoService');
...
module.exports = {
  ...
  createAppUpdateInfoService: createPrivateInstanceWrap(AppUpdateInfoService),
  createImageService: createPrivateInstanceWrap(ImageService)
};