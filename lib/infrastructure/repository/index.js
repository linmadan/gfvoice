const createImageRepository = require('./typeormImageRepository');

const createAppUpdateInfoRepository = require('./typeormAppUpdateInfoRepository');

const createFeedbackRepository = require('./typeormFeedbackRepository');

const createWordRepository = require('./typeormWordRepository');
