...
(function () {
    ...
    var FlakeId = module.exports = function (options) {
        ...
        if (typeof this.options.id !== 'undefined') {
            ...
            this.id = this.options.id & 0x7;
        } else {
            //this.id = ((this.options.datacenter || 0) & 0x1F) << 5 | ((this.options.worker || 0) & 0x1F);
            this.id = ((this.options.datacenter || 0) & 0x1) << 2 | ((this.options.worker || 0) & 0x3);
        }
        this.id <<= 19;  // id generator identifier - will not change while generating ids
    ...
    FlakeId.prototype = {
        ...
        next: function (cb) {
            ...
            id.writeUInt32BE(((time & 0x3) << 22) | this.id | this.seq << 11, 4);
